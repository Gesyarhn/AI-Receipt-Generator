...
const CUISINES = ['Any', 'Indonesian', 'Italian', 'Mexican', 'Indian', 'Chinese', 'Japanese', 'Thai', 'French', 'Mediterranean', 'American'];
...
const RecipeGenerator = () => {
    ...
    // Load user preferences on component mount (tambahan)
    useEffect(() => {
    ...
    const handleGenerate = async () => {
        ...
        //ada yang dihapus dan ditambahin (diubah) disini
        try {
